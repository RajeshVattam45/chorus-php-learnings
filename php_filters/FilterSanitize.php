...
// The FILTER_SANITIZE_NUMBER_INT filter removes
// all non-numeric characters except the + and - signs, resulting in +1234567890
...
// URL-encodes all characters that require encoding.
$input = "Hello World!";
